...
def elegir_imagen():
    ...
    if len(path_image) > 0:
        ...
        lblInfo2 = Label(root, text="¿Qué opcion te gustaria procesar?", width=25)
        ...
        btn2 = Button(root, text="Corte textura", width=25, command = corte)
        btn2.grid(column=0, row=5, padx=5, pady=5)
        btn3 = Button(root, text="Definicion de region geografica", width=25, command = geografia)
...
def reconocimiento():
    ...
    lblInfo2 = Label(root, text="IMAGEN SALIDA:")
